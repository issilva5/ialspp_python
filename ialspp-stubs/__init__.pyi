...
class Dataset:
    def __init__(self, filename: str, delim: str, string_id: bool = False) -> None:
        ...
...
class IALSppRecommender(Recommender):
    ...
    def Score(self, user: int, user_history: list[tuple[int, int]]) -> numpy.ndarray:
        ...
    def Train(self, dataset: Dataset) -> numpy.ndarray:
        ...
    def ComputeLosses(self, dataset: Dataset, train_prediction: numpy.ndarray) -> dict[str, float]:
        ...
